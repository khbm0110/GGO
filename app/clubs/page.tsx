                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className={`flex-1 py-2 px-3 rounded-lg font-bold text-sm flex items-center justify-center gap-2 transition-all ${
                        isFollowing ? 'bg-slate-800 text-white hover:bg-red-500/10 hover:text-red-500' : 'bg-primary text-slate-900 hover:bg-emerald-400'
                      }`}
                    >
                      {isFollowing ? (
                        <>
                    ...
                    <Link href={`/club/${club.id}`} className="p-2 bg-slate-800 text-slate-400 rounded-lg hover:text-white hover:bg-slate-700 transition-colors" title="زيارة الصفحة">
                      <ArrowRight size={20} />
                    </Link>
                  </div>
                </div>
